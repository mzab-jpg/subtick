...
export interface UserProfile {
  ...
  /** Threshold-based quick-exit rejection evidence, per preference axis, with a rolling window. Server-managed. */
  rejectionEvidence?: Record<string, { count: number; windowStart: number }>;
  lastUpdated: number;
}
